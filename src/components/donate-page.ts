...
import { Check, Copy, ExternalLink } from "lucide";
        ...
        <main class="max-w-2xl mx-auto px-6 py-14 flex flex-col gap-14">
          ...
          <div class="flex flex-col gap-4">
            ...
            <p class="text-ui-muted text-sm font-light leading-relaxed max-w-lg">
              ...
              If Speeedy has saved you time or made reading more comfortable, a contribution — in any form — is genuinely appreciated.
            </p>
          </div>

          <!-- Ways to support -->
          <div class="flex flex-col gap-3">
            <p class="text-xs tracking-[0.5em] uppercase text-ui-muted-subtle font-medium">Ways to contribute</p>

            <!-- Crypto -->
            <div class="border border-base-200 rounded-xl p-5 flex flex-col gap-4">
              <div class="flex items-center justify-between">
                <span class="text-sm font-medium text-base-content">Crypto donation</span>
                <span class="text-xs text-ui-muted-subtle font-light">Instant</span>
              </div>
              <div class="flex flex-col gap-3">
            ...
            <div class="border border-base-200 rounded-xl p-5 flex flex-col gap-3">
              ...
              <p class="text-sm text-ui-muted font-light leading-relaxed">
                Prefer a bank transfer, PayPal, or another method? Send me an email and we'll sort it out.
              </p>
              <a
            ...
            <!-- Non-monetary -->
            <div class="border border-base-200 rounded-xl p-5 flex flex-col gap-3">
              <span class="text-sm font-medium text-base-content">Other ways to help</span>
              <ul class="flex flex-col gap-2">
                ${[
									"Share your reading speed progress — hearing it works is the best motivation to keep building.",
									"Star the project on GitHub to help others discover it.",
									"Report bugs or suggest features — every piece of feedback shapes the next version.",
								].map(
									(item) => html`
              ...
              <a
                href="mailto:sami.bentaleb.dev@gmail.com?subject=Speeedy%20feedback"
                class="text-xs text-primary hover:underline underline-offset-2 w-fit"
              >
                Send a message or share your progress →
              </a>
            </div>
          </div>
          ...
          <div class="border border-base-200/60 rounded-xl p-5 flex flex-col gap-3 bg-base-200/20">
            ...
            <ol class="flex flex-col gap-2.5">
              ${[
								"Send any amount to one of the crypto addresses above.",
								"After your transaction confirms, email sami.bentaleb.dev@gmail.com with your TX hash and preferred display name.",
							].map(
								(step, i) => html`
            ...
            <p class="text-xs text-ui-muted-subtle font-light">
              Memo support: SOL natively supports memos. For ETH use the data field. For BTC use OP_RETURN.
            </p>
          </div>
